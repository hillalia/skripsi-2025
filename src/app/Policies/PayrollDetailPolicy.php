...
class PayrollDetailPolicy
{
    ...
    {
        return $user->can('view_any_payroll::detail');
    }
    ...
    {
        return $user->can('view_payroll::detail');
    }
    ...
    {
        return $user->can('create_payroll::detail');
    }
    ...
    {
        return $user->can('update_payroll::detail');
    }
    ...
    {
        return $user->can('delete_payroll::detail');
    }
    ...
    {
        return $user->can('delete_any_payroll::detail');
    }
     ...
     */
    public function replicate(User $user, PayrollDetail $payrollDetail): bool
    {
